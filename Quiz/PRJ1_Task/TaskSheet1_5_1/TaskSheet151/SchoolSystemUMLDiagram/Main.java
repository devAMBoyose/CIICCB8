public class Main {
    public static void main(String[] args) {
        // Build the model according to your diagram
        School school = new School("Java Integrated School");
        ...
        cs.addOffice(facultyRoom); // also located near faculty room (allowed)
        math.addOffice(officeB);

        // Teachers (1..*)
        Teacher t1 = new Teacher("T001", "Anna B.", "Java");
        ...
        // Print a quick summary so you can see relationships
        System.out.println("\n=== JAVA SCHOOL DETAILS ===");
